...
$order = $conn->query("SELECT o.*,concat(c.firstname,' ',c.lastname) as client, concat(d.first_name,' ',d.last_name) as delivery_partner  FROM `orders` o inner join clients c on c.id = o.client_id left join `delivery_partners` d on d.id = o.delivery_partner_id where o.id = '{$_GET['id']}' ");
if($order->num_rows > 0){
    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-6">
                ...
                <p>Delivery Partner: <?php echo $delivery_partner !=null ? $delivery_partner : 'Not Assigned' ?></p>
            </div>
