        ...
        <div class="container-fluid">
			<table class="table table-bordered table-stripped">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT o.*,concat(c.firstname,' ',c.lastname) as client, concat(d.first_name,' ',d.last_name) as delivery_partner from `orders` o inner join clients c on c.id = o.client_id left join delivery_partners d on d.id = o.delivery_partner_id order by unix_timestamp(o.date_created) desc ");
